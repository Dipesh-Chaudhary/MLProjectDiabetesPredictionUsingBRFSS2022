...
loaded_model = pickle.load(open("C:/DIPESH/study materials/sixth sem/PROJECT FOLDER/original dataset/2022 SAS/7 web app/knnTrainedModelFromScratch.sav","rb"))
